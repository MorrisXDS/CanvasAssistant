    ...
    <div className={styles.filterPanel}>
      ...
      <div className={styles.quickFilters}>
        ...
        <button
          ...
          onClick={() =>
            onStatusFilterChange(statusFilter === 'downloaded' ? 'all' : 'downloaded')
          }
        >
          Downloaded
        </button>
        ...
        <AccordionSection
          ...
          badge={
            <div className={styles.courseFilterActions}>
              ...
              <button
                className={styles.courseFilterAction}
        ...
        >
          <div className={styles.courseFilterList}>
            {(selectedPrefixes.size > 0
              ...
              const selectedInPrefix = prefixCourses.filter((c) =>
                isCourseFilterSelected(c.id)
              ).length;
