...
describe('FeatureFlags', () => {
  ...
  describe('getByCategory()', () => {
    it('should filter flags by category correctly', () => {
      ...
      expect(experimentalFlags.every((f) => f.category === FlagCategory.EXPERIMENTAL)).toBe(
        true
      );
  ...
  describe('userId and percentage rollouts', () => {
    it('should use default userId if not provided', () => {
      ...
      // Should not throw
      const result = flags.isEnabledForPercentage(
    ...
    it('should be consistent for same userId', () => {
      ...
      const result1 = flags.isEnabledForPercentage(
        'experimental.smart_priority_v2',
        50
      );
      const result2 = flags.isEnabledForPercentage(
        'experimental.smart_priority_v2',
        50
      );
      const result3 = flags.isEnabledForPercentage(
        'experimental.smart_priority_v2',
        50
      );
