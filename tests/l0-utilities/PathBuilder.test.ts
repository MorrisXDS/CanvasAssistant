...
describe('PathBuilder', () => {
  ...
  describe('getPageHtmlPath', () => {
    ...
    it('should truncate long page titles', () => {
      ...
      expect(result).toBe(path.join(filesDir, 'CSC108', 'Week_1', `${expectedTitle}.html`));
    });
  ...
  describe('getPageDependenciesPath', () => {
    ...
    it('should truncate long page titles', () => {
      ...
      const expectedTitle = 'A'.repeat(50);
      expect(result).toBe(path.join(filesDir, 'CSC108', 'Week_1', `${expectedTitle}_files`));
    });
  });
  ...
  describe('getResourcePathWithFolder', () => {
    it('should return correct nested structure', () => {
      const result = builder.getResourcePathWithFolder('CSC108', 'Lectures/Week 1', 'lecture.pdf');
      expect(result).toBe(path.join(filesDir, 'CSC108', 'Lectures', 'Week_1', 'lecture.pdf'));
    });

    it('should sanitize course code and folder path but preserve filename', () => {
      const result = builder.getResourcePathWithFolder('CS 108', 'Week@1/Lab#2', 'file.pdf');
      expect(result).toBe(path.join(filesDir, 'CS_108', 'Week_1', 'Lab_2', 'file.pdf'));
    });

    it('should handle single-level folder paths', () => {
      const result = builder.getResourcePathWithFolder('CSC108', 'Lectures', 'lecture.pdf');
