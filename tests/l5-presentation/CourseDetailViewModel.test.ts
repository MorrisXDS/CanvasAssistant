  ...
  describe('computeCourseDetailViewModel', () => {
    ...
    describe('task view models', () => {
      ...
      it('sorts tasks by due date ascending', () => {
        const course = createCourse({ id: 1 });
        const tasks = [
          createTask({ id: 1, courseId: 1, dueAt: '2024-03-01T00:00:00Z' }),
          createTask({ id: 2, courseId: 1, dueAt: '2024-01-01T00:00:00Z' }),
          createTask({ id: 3, courseId: 1, dueAt: '2024-02-01T00:00:00Z' }),
        ];
