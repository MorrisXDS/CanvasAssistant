...
describe('settingsSchema', () => {
  ...
  describe('SETTINGS_DEFAULTS', () => {
    it('should have defaults for all settings keys', () => {
      expect(SETTINGS_DEFAULTS[STORAGE_KEYS.SYNC_PREFS]).toEqual(DEFAULT_SYNC_PREFERENCES);
      expect(SETTINGS_DEFAULTS[STORAGE_KEYS.APPEARANCE]).toEqual(DEFAULT_APPEARANCE_SETTINGS);
      expect(SETTINGS_DEFAULTS[STORAGE_KEYS.NOTIFICATIONS]).toEqual(DEFAULT_NOTIFICATION_SETTINGS);
      expect(SETTINGS_DEFAULTS[STORAGE_KEYS.ACADEMIC]).toEqual(DEFAULT_ACADEMIC_SETTINGS);
      expect(SETTINGS_DEFAULTS[STORAGE_KEYS.FILE_EXPLORER]).toEqual(DEFAULT_FILE_EXPLORER_SETTINGS);
