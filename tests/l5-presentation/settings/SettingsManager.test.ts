...
describe('SettingsManager', () => {
  ...
  describe('get', () => {
    ...
    it('should return default when stored value is invalid', () => {
      localStorageMock.setItem(STORAGE_KEYS.APPEARANCE, JSON.stringify({ theme: 'invalid' }));
  ...
  describe('set', () => {
    ...
    it('should return false for invalid value', () => {
      ...
      const result = manager.set(STORAGE_KEYS.APPEARANCE, { theme: 'invalid' } as unknown as AppearanceSettings);
