...
import { RRuleExpander, CalendarEventRecord } from '../../src/layers/l2-daemon/RRuleExpander';

describe('RRuleExpander', () => {
  let expander: RRuleExpander;

  const createEvent = (overrides: Partial<CalendarEventRecord> = {}): CalendarEventRecord => ({
    id: 1,
