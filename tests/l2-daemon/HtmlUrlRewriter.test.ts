...
import { HtmlUrlRewriter, ResolvedDependency } from '../../src/layers/l2-daemon/HtmlUrlRewriter';
...
describe('HtmlUrlRewriter', () => {
  ...
  describe('HTML reference rewriting', () => {
    it('rewrites Canvas page URLs to relative paths', () => {
      ...
      expect(result).toBe('<a href="./Assignment1_files/instructions.html">See Instructions</a>');
    });
  ...
  describe('external URL handling', () => {
    it('preserves external URLs when keepExternalUrls is true', () => {
      ...
      const result = rewriter.rewrite(html, 'page.html', deps, { keepExternalUrls: true });
  ...
  describe('missing file handling', () => {
    it('uses Canvas URL for files without local path', () => {
      ...
      const result = rewriter.rewrite(html, 'page.html', deps, { fallbackToCanvasUrl: true });
  ...
  describe('relative path calculation', () => {
    it('calculates correct relative paths for nested HTMLs', () => {
      ...
      const deps: ResolvedDependency[] = [
        {
          canvasUrl: '/files/789',
          localPath: 'CSC108/Assignments/Assignment1_files/instructions_files/diagram.svg',
        },
      ];
  ...
  describe('special characters', () => {
    ...
    it('handles URLs with encoded characters', () => {
      const html = '<a href="/courses/123/files/456/download?filename=test%20file.pdf">Link</a>';
      const deps: ResolvedDependency[] = [
        {
