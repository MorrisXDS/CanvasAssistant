...
import { ResilienceWrapper } from '../../src/layers/l2-daemon/resilience/ResilienceWrapper';
import { CircuitOpenError } from '../../src/layers/l2-daemon/resilience/CircuitBreaker';
...
describe('ResilienceWrapper', () => {
  ...
  describe('execute', () => {
    ...
    it('should reject immediately when circuit is open', async () => {
      ...
      await expect(
        wrapper.execute(async () => 'success', 'test-endpoint')
